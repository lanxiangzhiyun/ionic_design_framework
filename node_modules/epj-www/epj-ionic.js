...
angular.module('epj-ionic', [])
.service('EpjService', ['$rootScope','$ionicHistory','$timeout','$ionicViewSwitcher','$location', function($rootScope,$ionicHistory,$timeout,$ionicViewSwitcher,$location) {
  return {
